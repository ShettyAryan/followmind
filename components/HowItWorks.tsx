...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-32 px-6 relative" ref={ref}>
      {/* Ambient glow */}
      <div
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Headline */}
        <h2 className="reveal reveal-delay-1 font-serif text-[clamp(2rem,5vw,3.5rem)] text-[#F0F4FF] leading-tight tracking-tight mb-20 max-w-xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 relative">
          ...
          {steps.map((step, i) => (
            <div
              key={step.n}
              className={`reveal reveal-delay-${i + 1} glass card-glow rounded-2xl p-8 border border-white/8 transition-all duration-300 relative group`}
            >
              {/* Step number */}
              ...
              <h3 className="text-[#F0F4FF] text-xl font-semibold mb-3 tracking-tight">
                {step.title}
              </h3>
